            ...
            <div id="noteForm">
                <form>
                    <div className="inpfld">
                        ...
                        <input type="text" name="title" id="title" value={inpValue.title} onChange={inpFldChange} placeholder="Enter Note Title" />
                    </div>
                    <div className="inpfld textarea">
                        <label htmlFor="discription">Discription:</label>
                        <textarea name="discription" id="discription" cols="30" rows="10"
                            value={inpValue.discription} onChange={inpFldChange} placeholder="Enter Note Discription">
                        </textarea>
                    ...
                    <div className="inpfld">
                        ...
                        <input type="text" name="category" id="category"
                            onClick={() => setInpValue({ ...inpValue, category: "" })} value={inpValue.category} onChange={inpFldChange} placeholder="Enter note category. Example: General" />
                    </div>
