...
const NoteForm = () => {
    ...
    const HomeAllNote = allNote.slice(0).reverse();
    const actualNote = HomeAllNote.slice(0, 4)
    ...
    return (
        <>
            <div id="noteForm">
                <form>
                    ...
                    <div className="inpfld textarea">
                        ...
                        <div className="lettercount" style={mode === "dark" ? { backgroundColor: "rgb(25, 25, 26)", color: "white" } : {}} >
            ...
            <hr />
            <HomeCard cardDetail={actualNote} />
        </>
    )
}
